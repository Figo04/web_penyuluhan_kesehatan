    ...
    <div class="instruction-box">
        ...
        <div class="instruction-body open" id="instrBody">
            ...
            <div class="instruction-section">
                ...
                <div class="instruction-item">
                    <div class="instruction-bullet"></div>
                    <span>Pastikan semua soal telah dijawab sebelum menekan tombol <strong>Selesaikan Post-Test</strong>.</span>
                </div>
            </div>
            ...
            <div class="instruction-section">
                ...
                <div class="likert-legend">
                    <div class="likert-chip chip-ss">
                        <span class="chip-abbr">SS</span><span class="chip-eq">=</span><span>Sangat Setuju</span>
                    </div>
                    <div class="likert-chip chip-s">
                        <span class="chip-abbr">S</span><span class="chip-eq">=</span><span>Setuju</span>
                    </div>
                    <div class="likert-chip chip-r">
                        <span class="chip-abbr">R</span><span class="chip-eq">=</span><span>Ragu-ragu / Netral</span>
                    </div>
                    <div class="likert-chip chip-ts">
                        <span class="chip-abbr">TS</span><span class="chip-eq">=</span><span>Tidak Setuju</span>
                    </div>
                    <div class="likert-chip chip-sts">
                        <span class="chip-abbr">STS</span><span class="chip-eq">=</span><span>Sangat Tidak Setuju</span>
                    </div>
                </div>
